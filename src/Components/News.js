...
const News = (props) => {
  ...
  const updateNews = async () => {
    props.setProgress(0);
    let url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=ccf89d82c55f4e94857bdd7a61b96878&page=${page}&pageSize=${props.pageSize}`;
    setLoading(true);
